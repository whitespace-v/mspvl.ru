...
const PriceItem = sequelize.define('price_item', {
    id:                  {type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true},
    priceCategoryId:     {type: DataTypes.INTEGER, allowNull: false },
    name:                {type: DataTypes.STRING,    allowNull: false },
})
...
PriceCategory.hasMany(PriceItem,{as: 'items'})
PriceItem.belongsTo(PriceCategory)
...
//export
module.exports = {
    User, Vehicle, VehicleField, VehicleImage, Category, Review, PriceCategory, PriceItem
}